const valores = [7.7, 7.6, 7.4, 8.7]//array
console.log(valores[0],  valores[3])//mostrar o valor 0 e 3
console.log(valores[4])//pedi para imprimir o valor 4, mas não existia, logo criei embaixo...

valores[4] = 10 //passou a ter o elemento de indice 4
console.log(valores)
console.log(valores.length)//anotei no caderno
